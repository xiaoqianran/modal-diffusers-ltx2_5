...
【結論(2026-09-09): 本番では利得なし → 既定 off の実験的フラグとして残置。
 nvfp4-fast プリセットには焼き込まない。graph 単体(ltx25/acceleration/cuda_graph.py)が本番構成】
...
CUDA Graph(ltx25/acceleration/cuda_graph.py)と併用すること** -- compiled eager 単体は graph break /
